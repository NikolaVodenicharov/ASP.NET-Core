...
namespace CameraBazaar2.Data.Migrations
{
    ...
    [Migration("20190613094406_QuantitySyntaxError")]
    partial class QuantitySyntaxError
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CameraBazaar2.Data.Models.Camera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CameraBazaar2.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("CameraBazaar2.Data.Models.Camera", b =>
                {
                    b.HasOne("CameraBazaar2.Data.Models.User", "User")
                        .WithMany("Cameras")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CameraBazaar2.Data.Models.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
